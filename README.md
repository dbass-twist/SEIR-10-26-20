...
# Welcome to General Assembly SEIR-10-26-20
...
- Course duration: Monday, October 26th, 2020 - Wednesday, February 3rd, 2021 (60 days - not including holidays)
- Holidays:
	- November 3rd, 11th & 25th-27th
...
For your convenience, recordings of the lessons will be available to review at 
 [YouTube](https://www.youtube.com/playlist?list=PLt-s1HdZuBB0q7KyqTEo6VSQ2OckkZ1DT).
...
2. In another tab, browse to the GA class repo:  [https://git.generalassemb.ly/SEI-CC/SEIR-10-26-20](https://git.generalassemb.ly/SEI-CC/SEIR-10-26-20)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/SEI-CC/SEIR-10-26-20
```

You can now `$ cd SEIR-10-26-20` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/SEI-CC/SEIR-10-26-20.git
```
